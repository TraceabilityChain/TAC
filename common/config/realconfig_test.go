...
import (
	...
	"github.com/traceabilitychain/tacchain/common/config/msp"
	"github.com/traceabilitychain/tacchain/common/configtx"
	"github.com/traceabilitychain/tacchain/common/configtx/tool/localconfig"
...
func init() {
	// We are in tacchain/common/config/ but need to execute from tacchain/
	err := os.Chdir("../..")
	if err != nil {
		panic(err)
	}
