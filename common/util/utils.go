...
import (
	...
	"github.com/traceabilitychain/tacchain/common/metadata"
)
...
//"upgrades" from user and relationship with "tacchain" upgrade. For
//now keep it simple and use the tacchain's version stamp
