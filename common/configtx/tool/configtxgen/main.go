...
import (
	...
	"github.com/traceabilitychain/tacchain/bccsp/factory"
	"github.com/traceabilitychain/tacchain/common/config"
	mspconfig "github.com/traceabilitychain/tacchain/common/config/msp"
	"github.com/traceabilitychain/tacchain/common/configtx"
	"github.com/traceabilitychain/tacchain/common/configtx/tool/configtxgen/metadata"
	genesisconfig "github.com/traceabilitychain/tacchain/common/configtx/tool/localconfig"
	"github.com/traceabilitychain/tacchain/common/configtx/tool/provisional"
		...
		if err := recover(); err != nil {
			if strings.Contains(fmt.Sprint(err), "Error reading configuration: Unsupported Config Type") {
				logger.Error("Could not find configtx.yaml. " +
					"Please make sure that TACCHAIN_CFG_PATH is set to a path " +
