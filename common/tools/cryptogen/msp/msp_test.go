...
import (
	...
	"github.com/traceabilitychain/tacchain/common/tools/cryptogen/ca"
	"github.com/traceabilitychain/tacchain/common/tools/cryptogen/msp"
	tacchainmsp "github.com/traceabilitychain/tacchain/msp"
...
func TestGenerateLocalMSP(t *testing.T) {
	...
	testMSPConfig, err := tacchainmsp.GetLocalMspConfig(mspDir, nil, testName)
	assert.NoError(t, err, "Error parsing local MSP config")
	testMSP, err := tacchainmsp.NewBccspMsp()
...
func TestGenerateVerifyingMSP(t *testing.T) {
	...
	testMSPConfig, err := tacchainmsp.GetVerifyingMspConfig(mspDir, testName)
